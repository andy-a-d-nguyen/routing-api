...
type FakeSubStatter struct {
	...
	SetSamplerFuncStub        func(metrics.SamplerFunc)
	setSamplerFuncMutex       sync.RWMutex
	setSamplerFuncArgsForCall []struct {
		arg1 metrics.SamplerFunc
	}
...
func (fake *FakeSubStatter) Dec(arg1 string, arg2 int64, arg3 float32) error {
	fake.decMutex.Lock()
...
func (fake *FakeSubStatter) DecCalls(stub func(string, int64, float32) error) {
	fake.decMutex.Lock()
	defer fake.decMutex.Unlock()
	fake.DecStub = stub
}

func (fake *FakeSubStatter) DecArgsForCall(i int) (string, int64, float32) {
	fake.decMutex.RLock()
	defer fake.decMutex.RUnlock()
...
func (fake *FakeSubStatter) Gauge(arg1 string, arg2 int64, arg3 float32) error {
...
func (fake *FakeSubStatter) GaugeCalls(stub func(string, int64, float32) error) {
	fake.gaugeMutex.Lock()
	defer fake.gaugeMutex.Unlock()
	fake.GaugeStub = stub
}

func (fake *FakeSubStatter) GaugeArgsForCall(i int) (string, int64, float32) {
	fake.gaugeMutex.RLock()
	defer fake.gaugeMutex.RUnlock()
...
func (fake *FakeSubStatter) GaugeDelta(arg1 string, arg2 int64, arg3 float32) error {
...
func (fake *FakeSubStatter) GaugeDeltaCalls(stub func(string, int64, float32) error) {
	fake.gaugeDeltaMutex.Lock()
	defer fake.gaugeDeltaMutex.Unlock()
	fake.GaugeDeltaStub = stub
}

func (fake *FakeSubStatter) GaugeDeltaArgsForCall(i int) (string, int64, float32) {
	fake.gaugeDeltaMutex.RLock()
	defer fake.gaugeDeltaMutex.RUnlock()
...
func (fake *FakeSubStatter) Inc(arg1 string, arg2 int64, arg3 float32) error {
	fake.incMutex.Lock()
...
func (fake *FakeSubStatter) IncCalls(stub func(string, int64, float32) error) {
	fake.incMutex.Lock()
	defer fake.incMutex.Unlock()
	fake.IncStub = stub
}

func (fake *FakeSubStatter) IncArgsForCall(i int) (string, int64, float32) {
	fake.incMutex.RLock()
	defer fake.incMutex.RUnlock()
...
func (fake *FakeSubStatter) NewSubStatter(arg1 string) metrics.SubStatter {
...
func (fake *FakeSubStatter) NewSubStatterCalls(stub func(string) metrics.SubStatter) {
	fake.newSubStatterMutex.Lock()
...
func (fake *FakeSubStatter) NewSubStatterReturns(result1 metrics.SubStatter) {
	fake.newSubStatterMutex.Lock()
	defer fake.newSubStatterMutex.Unlock()
...
func (fake *FakeSubStatter) NewSubStatterReturnsOnCall(i int, result1 metrics.SubStatter) {
	fake.newSubStatterMutex.Lock()
	defer fake.newSubStatterMutex.Unlock()
	fake.NewSubStatterStub = nil
...
func (fake *FakeSubStatter) Raw(arg1 string, arg2 string, arg3 float32) error {
	fake.rawMutex.Lock()
...
func (fake *FakeSubStatter) RawCalls(stub func(string, string, float32) error) {
	fake.rawMutex.Lock()
	defer fake.rawMutex.Unlock()
	fake.RawStub = stub
}

func (fake *FakeSubStatter) RawArgsForCall(i int) (string, string, float32) {
	fake.rawMutex.RLock()
	defer fake.rawMutex.RUnlock()
...
func (fake *FakeSubStatter) Set(arg1 string, arg2 string, arg3 float32) error {
	fake.setMutex.Lock()
...
func (fake *FakeSubStatter) SetCalls(stub func(string, string, float32) error) {
	fake.setMutex.Lock()
	defer fake.setMutex.Unlock()
	fake.SetStub = stub
}

func (fake *FakeSubStatter) SetArgsForCall(i int) (string, string, float32) {
	fake.setMutex.RLock()
	defer fake.setMutex.RUnlock()
...
func (fake *FakeSubStatter) SetInt(arg1 string, arg2 int64, arg3 float32) error {
...
func (fake *FakeSubStatter) SetIntCalls(stub func(string, int64, float32) error) {
	fake.setIntMutex.Lock()
	defer fake.setIntMutex.Unlock()
	fake.SetIntStub = stub
}

func (fake *FakeSubStatter) SetIntArgsForCall(i int) (string, int64, float32) {
	fake.setIntMutex.RLock()
	defer fake.setIntMutex.RUnlock()
...
func (fake *FakeSubStatter) SetSamplerFunc(arg1 metrics.SamplerFunc) {
...
func (fake *FakeSubStatter) SetSamplerFuncCalls(stub func(metrics.SamplerFunc)) {
	fake.setSamplerFuncMutex.Lock()
	defer fake.setSamplerFuncMutex.Unlock()
	fake.SetSamplerFuncStub = stub
}

func (fake *FakeSubStatter) SetSamplerFuncArgsForCall(i int) metrics.SamplerFunc {
	fake.setSamplerFuncMutex.RLock()
	defer fake.setSamplerFuncMutex.RUnlock()
...
func (fake *FakeSubStatter) Timing(arg1 string, arg2 int64, arg3 float32) error {
...
func (fake *FakeSubStatter) TimingCalls(stub func(string, int64, float32) error) {
	fake.timingMutex.Lock()
	defer fake.timingMutex.Unlock()
	fake.TimingStub = stub
}

func (fake *FakeSubStatter) TimingArgsForCall(i int) (string, int64, float32) {
	fake.timingMutex.RLock()
	defer fake.timingMutex.RUnlock()
...
func (fake *FakeSubStatter) TimingDuration(arg1 string, arg2 time.Duration, arg3 float32) error {
...
func (fake *FakeSubStatter) TimingDurationCalls(stub func(string, time.Duration, float32) error) {
	fake.timingDurationMutex.Lock()
	defer fake.timingDurationMutex.Unlock()
	fake.TimingDurationStub = stub
}

func (fake *FakeSubStatter) TimingDurationArgsForCall(i int) (string, time.Duration, float32) {
	fake.timingDurationMutex.RLock()
	defer fake.timingDurationMutex.RUnlock()
...
var _ metrics.SubStatter = new(FakeSubStatter)
